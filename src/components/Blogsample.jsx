...
const Blogsample = () => {
  ...
  return (
   <div className='w-full h-full '>
     <div className='w-full h-full  px-5 py-2.5  gap-5 bg-white grid grid-cols-12 justify-center items-center '>
      <div className='h-[90%] col-start-1 col-end-10  rounded-2xl  bg-purple-100 px-5 py-2.5'>
